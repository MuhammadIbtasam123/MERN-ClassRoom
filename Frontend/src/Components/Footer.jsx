    ...
    <footer className=" bg-gray-200 ">
      <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
              ...
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-grey-900 ml-2">
                Class Companion
              </span>
            </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-grey-900 font-medium">
                <li className="mb-4">
            ...
            <div>
              ...
              <ul className="dark:text-grey-900 dark:text-grey-900 font-medium">
                <li className="mb-4">
                  <a
                    href="https://github.com/MuhammadIbtasam123"
                    className="hover:underline "
                  >
                    Github
                  </a>
            ...
            <div>
              ...
              <ul className="dark:text-grey-900 font-medium">
                <li className="mb-4">
                  <a href="#" className="hover:underline">
                    Privacy Policy
                  </a>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-grey-900 sm:text-center text-grey-900">
            © 2024{" "}
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd" // Change 'clip-rule' to 'clipRule'
